...
//
//  Holt einen i16-Operanden (imm16)
//
CArgument* get_immed_word()
{
    ...
    if(relo) {
        read_word();
        return new CArgument(0, 2, new CRelo(relo));
    } else
        return new CArgument(read_word(), 2);
}

//
//  Holt einen i8-Operanden (imm8)
//
CArgument* get_immed_byte()
{
    return new CArgument(read_byte(), 1);
}
...
CInstruction* decode_386()
{
    ...
    if(opcode >= 0x80 && opcode <= 0x8F) {
        ...
        if(!relo) {
            ...
            read_word();
            a = new CArgument(0, 0, new CRelo(relo));
        }
...
CInstruction* decode_one(int& opcode_ip)
{
    ...
    case 4: // AND
        ...
        if(opcode==0x27) // DAA
            return (new CInstruction(I_BCD))->set_param(opcode);
    ...
    case 12: // 186/286/386  60..67
        switch(opcode) {
        case 0x60:
            return new CInstruction(I_PUSHA);
        case 0x61:
            return new CInstruction(I_POPA);
    ...
    case 16: // 80..87
        ...
        case 0x84:
            return rm_r_insn(I_TEST,byte_regs);
        case 0x85:
            return rm_r_insn(I_TEST,word_regs);
        case 0x86:
            return rm_r_insn(I_XCHG,byte_regs);
        case 0x87:
            return rm_r_insn(I_XCHG,word_regs);
        }
        return 0;
    case 17: // 88..8F
        switch(opcode) {
    ...
    case 19: // 98..9F
        ...
        case 0x9A:
            ...
            ip += 4;
            return new CInstruction(I_CALLF, new CArgument(0, 0, new CRelo(relo)));
        case 0x9B: // WAIT
            throw string("FPU is not supported");
        case 0x9C:
            return new CInstruction(I_PUSHF);
        case 0x9D:
            return new CInstruction(I_POPF);
        case 0x9E:
            return new CInstruction(I_SAHF);
        case 0x9F:
            return new CInstruction(I_LAHF);
        }
        return 0;
    case 20: // A0..A7
        switch(opcode) {
    ...
    case 21: // A8-AF
        switch(opcode) {
        case 0xA8:
            return new CInstruction(I_TEST,
                                new CArgument(rAL),
                                get_immed_byte());
        case 0xA9:
            return new CInstruction(I_TEST,
    ...
    case 24: // C0..C7
        ...
        case 0xC3:
            return new CInstruction(I_RETN, new CArgument(0, 2));
        case 0xC4:
    ...
    case 25: // C8..CF
        ...
        case 0xCB:
            return new CInstruction(I_RETF, new CArgument(0, 2));
        case 0xCC:
        case 0xCD:
        case 0xCE:
        case 0xCF:
    ...
    case 26: // D0..D7
        ...
        case 0xD0:
            ...
            return (new CInstruction(shift_insns[last_reg],
                                     a,
                                     new CArgument(1, 1)))->set_os(1);
        case 0xD1:
            a = decode_mod_rm(word_regs);
            return (new CInstruction(shift_insns[last_reg],
                                     a,
                                     new CArgument(1, 1)))->set_os(2);
        case 0xD2:
            a = decode_mod_rm(byte_regs);
            return (new CInstruction(shift_insns[last_reg],
                                     a,
        ...
        case 0xD4: case 0xD5: // AAM/AAD
            return (new CInstruction(I_BCD, get_immed_byte()))->set_param(opcode)->set_os(2);
        case 0xD6:
            return new CInstruction(I_SETALC);
        case 0xD7:
            return new CInstruction(I_XLAT);
        }
        return 0;
    case 27: // Copro
        throw string("FPU is not supported.");
    ...
    case 29: // E8..EF
        ...
        case 0xEA:
            ...
            ip += 4;
            return new CInstruction(I_JMPF, new CArgument(0, 0, new CRelo(relo)));
        case 0xEB:
            w = read_byte();
        ...
        case 0xEC:
            return (new CInstruction(I_IN,
                                     new CArgument(rAL),
                                     new CArgument(rDX)))->set_os(1);
        case 0xED:
            return (new CInstruction(I_IN,
                                     new CArgument(rAX),
                                     new CArgument(rDX)))->set_os(2);
        case 0xEE:
            return (new CInstruction(I_OUT,
                                     new CArgument(rAL),
                                     new CArgument(rDX)))->set_os(1);
...
CArgument* disp16_arg()
{
    ...
    if(relo)
        return new CArgument(rNONE, rNONE, 0, 0, new CRelo(relo), seg_ovr);
    else
        return new CArgument(rNONE, rNONE, disp, 2, 0, seg_ovr);
}
...
CArgument* decode_mod_rm(TRegister* regs)
{
    ...
    if(relo) disp=0;
    return new CArgument(bases[mod_rm & 7], index[mod_rm & 7], disp, 2,
